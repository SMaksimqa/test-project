...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic(
        ...
        focus=(
            ...
            "затем при необходимости одна деталь. ВАЖНО: хотя бы в одном пункте "
            "обязательно укажи цену (бери её из заголовков, где она есть, — "
            "в рублях или долларах, как в источнике). Не выдумывай цену, если "
            "её нет ни в одном заголовке. Допускается лёгкая ирония. Избегай "
            "рекламного тона и сухого перечисления характеристик."
        ),
    ),
    Topic(
        key="cars",
