...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic(
        ...
        focus=(
            "Новости Москвы. По возможности отдай приоритет югу города (ЮАО, "
            "южные районы); если южных новостей нет — бери общегородские. "
            "Дай 3–4 пункта."
        ),
    ),
    Topic(
        ...
        focus=(
            "Дай ровно 1 пункт строго про курс доллара к рублю: текущий "
            "уровень и куда движется (растёт/падает) по самым свежим новостям. "
            "Никаких инвестиционных советов, прогнозов покупки/продажи и "
            "других валют."
        ),
        keywords=("доллар",),
    ),
    ...
    Topic(
        ...
        title="🚗 Авто",
        feeds=(
            "https://news.google.com/rss/search?q=%D0%B0%D0%B2%D1%82%D0%BE%D1%80%D1%8B%D0%BD%D0%BE%D0%BA%20%D0%A0%D0%BE%D1%81%D1%81%D0%B8%D0%B8%20%D0%BD%D0%BE%D0%B2%D1%8B%D0%B5%20%D0%BC%D0%BE%D0%B4%D0%B5%D0%BB%D0%B8%20%D1%86%D0%B5%D0%BD%D1%8B&hl=ru&gl=RU&ceid=RU:ru",
            "https://news.google.com/rss/search?q=%D0%BD%D0%BE%D0%B2%D1%8B%D0%B5%20%D0%B0%D0%B2%D1%82%D0%BE%D0%BC%D0%BE%D0%B1%D0%B8%D0%BB%D0%B8%20%D0%BD%D0%BE%D0%B2%D0%B8%D0%BD%D0%BA%D0%B8%20%D0%B2%20%D0%BC%D0%B8%D1%80%D0%B5&hl=ru&gl=RU&ceid=RU:ru",
        ),
        focus=(
            "Дай 1–2 пункта: один про авторынок России (новые/выходящие "
            "модели, динамика цен), и при наличии один про мировые "
            "автоновинки или новые технологии в авто. Живо, без рекламы "
            "автосалонов."
        ),
    ),
    Topic(
        ...
        title="🧳 Туризм",
        feeds=(
            "https://news.google.com/rss/search?q=%D1%82%D1%83%D1%80%D1%8B%20%D0%BF%D1%83%D1%82%D1%91%D0%B2%D0%BA%D0%B8%20%D1%86%D0%B5%D0%BD%D1%8B%20%D0%BE%D1%82%D0%B4%D1%8B%D1%85%20%D0%B3%D0%BE%D1%80%D1%8F%D1%89%D0%B8%D0%B5&hl=ru&gl=RU&ceid=RU:ru",
        ),
        focus=(
            "Дай ровно 1 пункт про туризм: цены на туры/путёвки, горящие "
            "предложения, выгодные направления (например, удачная цена тура "
            "на популярный курорт). Без рекламы конкретных турагентств."
        ),
    ),
    Topic(
        key="worldcup",
