...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic(
        ...
        focus=(
            ...
            "и чем это интересно/необычно (главная фишка, кто производитель), "
            "затем при необходимости одна деталь. Если в источнике указана "
            "цена — обязательно укажи её в рублях; если цены в источнике нет, "
            "не выдумывай её. Допускается лёгкая ирония. Избегай рекламного "
            "тона и сухого перечисления характеристик."
        ),
    ),
    Topic(
        key="cars",
